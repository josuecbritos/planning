...
2. Aplica el esquema **completo**, las 28 migraciones en orden:
   ```bash
...
> La lista **completa y ordenada** de las 28 migraciones (1→28), lista para
...
supabase/
  migrations/            28 migraciones (1→28). Lista ordenada en DEPLOY.md.
