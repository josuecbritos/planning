...
2. Aplica el esquema **completo**, las 25 migraciones en orden:
   ```bash
...
> La lista **completa y ordenada** de las 25 migraciones (1→25), lista para
...
supabase/
  migrations/            25 migraciones (1→25). Lista ordenada en DEPLOY.md.
