...
2. Aplica el esquema **completo**, las 24 migraciones en orden:
   ```bash
...
> La lista **completa y ordenada** de las 24 migraciones (1→24), lista para
...
supabase/
  migrations/            24 migraciones (1→24). Lista ordenada en DEPLOY.md.
