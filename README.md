...
2. Aplica el esquema **completo**, las 23 migraciones en orden:
   ```bash
...
> La lista **completa y ordenada** de las 23 migraciones (1→23), lista para
...
supabase/
  migrations/            23 migraciones (1→23). Lista ordenada en DEPLOY.md.
