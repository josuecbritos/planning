...
2. Aplica el esquema **completo**, las 27 migraciones en orden:
   ```bash
...
> La lista **completa y ordenada** de las 27 migraciones (1→27), lista para
...
supabase/
  migrations/            27 migraciones (1→27). Lista ordenada en DEPLOY.md.
