...
2. Aplica el esquema **completo**, las 29 migraciones en orden:
   ```bash
...
> La lista **completa y ordenada** de las 29 migraciones (1→29), lista para
...
supabase/
  migrations/            29 migraciones (1→29). Lista ordenada en DEPLOY.md.
