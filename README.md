...
2. Aplica el esquema **completo**, las 26 migraciones en orden:
   ```bash
...
> La lista **completa y ordenada** de las 26 migraciones (1→26), lista para
...
supabase/
  migrations/            26 migraciones (1→26). Lista ordenada en DEPLOY.md.
