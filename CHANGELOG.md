...
- **Filtros y orden guardables como "vista":** por Fecha Objetivo (relativas Hoy /
  ...
  el scroll y el bloque se veía abierto por arriba). Los desplegables de filtro
  se muestran **por encima del contenedor** (no se recortan aunque la tabla sea
  corta, p. ej. en Mis Tareas).
